...
import './uniqMovieTrailers.css'

function UniqMovieTrailers({id}) {
    ...
    const fetchTrailer = async() => {
        // uniqMoviesTrailer
        const responseTrailer = await axios.get(`https://api.themoviedb.org/3/movie/${id}/videos?api_key=f9fd8699f04bbaf7bf3c77275c0981c9&language=en-US`)
...
export default UniqMovieTrailers